...
from exp.Exp_Long_Term_Forecast_ESDWL import Exp_Long_Term_Forecast_ESDWL
import random
...
if __name__ == '__main__':
    ...
    parser.add_argument('--patch_sizes', type=int, default=32, help='patch_sizes')
    ...
    # random seed
    fix_seed = args.random_seed #3047
    ...
    elif args.task_name == 'ESDWL':
        Exp = Exp_Long_Term_Forecast_ESDWL
    else:
        Exp = Exp_Long_Term_Forecast
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_df{}_el{}_dl{}_pa{}_baz{}_efact{}_dstate{}_nh{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
